...
baidu.query.extend({
    css: function(key, value){
        baidu.check('^(?:(?:string(?:,(?:number|string|function))?)|object)$', 'baidu.query.css');
        return baidu.dom._access(this, key, value, function(ele, key, val){
            var styleFixer = baidu.query.styleFixer;
