...
var QUnit = {
	...
	test: function(testName, expected, callback, async) {
		...
		if(window.location.href.indexOf("download=1") > -1 && (testName.indexOf("老接口") > -1 || testName.indexOf("兼容Magic接口") > -1 || testName.indexOf("兼容1.x接口") > -1 || testName.indexOf("sizzle接口") > -1)){
			callback = function(){
			}
		}
		
		if(window.location.href.indexOf("download=2") > -1 && (testName.indexOf("老接口") > -1 || testName.indexOf("兼容Magic接口") > -1 || testName.indexOf("sizzle接口") > -1)){
			callback = function(){
			}
		}
		
		if(window.location.href.indexOf("download=3") > -1 && testName.indexOf("sizzle接口") > -1){
			callback = function(){
			}
		}
		
		if(window.location.href.indexOf("download=4") > -1 && (testName.indexOf("老接口") > -1 || testName.indexOf("兼容1.x接口") > -1 || testName.indexOf("sizzle接口") > -1)){
			callback = function(){
			}
		}
