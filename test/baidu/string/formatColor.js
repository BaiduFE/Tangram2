...
test('param color', function() {
	...
	var c1 = baidu.string(color1).formatColor();
	var c2 = baidu.string(color2).formatColor();
	var c3 = baidu.string(color3).formatColor();
	var c4 = baidu.string(color4).formatColor();
