...
test("老接口：中英文混合加上标点符号的字符串", function(){
	equals(baidu.string.getByteLength('love? 中国 life#'), 16);
}); // 5

//空串和异常情况
test("老接口：空串", function(){
	equals(baidu.string.getByteLength(""), 0);
}); // 6
