...
test("老接口：URL中只有一个参数的情况", function(){
...
test("老接口：URL中不止一个参数的情况", function(){
...
test("老接口：URL中不止一个参数，并且key中带转义字符的情况", function(){
