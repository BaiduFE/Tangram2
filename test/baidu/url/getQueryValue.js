...
test("老接口：URL中只有一个参数时，指定存在的key", function(){
...
test("老接口：URL中只有一个参数时，指定不存在的key", function(){
...
test("老接口：URL中不止一个参数时，指定存在的key", function(){
...
test("老接口：URL中不止一个参数时，指定不存在的key", function(){
...
test("老接口：URL中不止一个参数时，key是值为空的参数", function(){
...
test("老接口：URL中不止一个参数时，key为带转义字符的参数", function(){
...
test("老接口：URL中存在相同的参数，指定key为该参数，取第一次出现的值", function(){
	//key完全相同
...
test("老接口：URL中存在#时，取?和#中间的值", function(){
