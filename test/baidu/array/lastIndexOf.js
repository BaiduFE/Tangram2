...
test("正常用例",function(){
    ...
    r = baidu.array(arraytest).lastIndexOf(5);
    equal(r,5,"查询数组元素");
    r = baidu.array(arraytest).lastIndexOf(10);
    equal(r,-1,"查询不存在的数组元素");
    r = baidu.array(arraytest).lastIndexOf(5, -2);
    equal(r,1,"负数的情况");
});
...
test("特殊数组",function(){
    ...
    var r = baidu.array(arraytest).lastIndexOf('name');
    equal(r,8,"查询特殊数组项");
    arraytest = [2,5,8,19,'name','44',56,5,'name'];
    var i = 5;
    r = baidu.array(arraytest).lastIndexOf(i);
    equal(r,7,"查询数组项");
    r = baidu.array(arraytest).lastIndexOf('help');
    equal(r,-1,"查询不存在的数组项");
});
...
test("异常用例",function(){
    ...
    r = baidu.array(arraytest).lastIndexOf(fn);
    equal(r,-1,"空数组查询函数");
});
