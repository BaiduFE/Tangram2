...
test("正常用例", function() {
	...
	baidu.array(arraytest).remove(60);
	array = [ 1, '1', 2, '2', '35', 40 ];
...
test("空数组", function() {
	expect(3);
	var array = [];
	baidu.array(array).remove(2);
	equal(array.toString(), "", "空数组删除元素");
	baidu.array(array).remove(array, function(x) {
		return false;
	});
	;
