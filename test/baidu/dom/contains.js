...
//				clearInterval(handle);
			...
			ok(!baidu.dom(div).contains(divFrame),"div doesn't contain div in iframe");
			ok(baidu.dom(div).contains(f),"div contains iframe");
			ok(baidu.dom(divFrame).contains(imgFrame),"in iframe,div contains img");//in frame, div contains img
			document.body.removeChild(div);
			start();
		}
	});	
